...
public class EmployeeManager {
	...
	for(int i =0;i<100;i++) {
	 ...
	 new Employee(inputName,inputAge,inputDepartment,inputSalary).addToDatabase();
	...
	System.out.println("Would you like to see the database? [y/n]");
		inputResponse=read.nextLine();
			if(inputResponse.equals("y")) {
				...
				System.out.println("Map: "+Employee.database);
				System.out.println("Set:" + Employee.employeeSet);
